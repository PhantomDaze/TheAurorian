...
public class CommonConfig {
    ...
    static {
        ...
        builder.pop();
        builder.push("Mobs").comment("Nearby-density multipliers for dungeon and temple hostiles.");
        ...
        builder.pop();
        builder.push("World Gen").comment("Toggles for Aurorian structure generation. Runestone uses a custom structure assembled from upstream templates.");
