...
public class EntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MoonQueenEntity>> moon_queen = ENTITIES.register("moon_queen", () -> EntityType.Builder.<MoonQueenEntity>of(MoonQueenEntity::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8).fireImmune().build("moon_queen"));
