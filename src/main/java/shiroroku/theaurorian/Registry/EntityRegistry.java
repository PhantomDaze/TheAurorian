...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<UndeadKnightEntity>> undead_knight = ENTITIES.register("undead_knight", () -> EntityType.Builder.<UndeadKnightEntity>of(UndeadKnightEntity::new, MobCategory.MONSTER).sized(0.6F * 1.3F, 1.95F * 1.3F).clientTrackingRange(8).fireImmune().build("undead_knight"));
