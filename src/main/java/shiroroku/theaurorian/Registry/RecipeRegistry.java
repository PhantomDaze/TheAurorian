...
public class RecipeRegistry {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<MoonlightForgeRecipe>> moonlight_forge_serializer =
            SERIALIZERS.register("moonlight_forge", MoonlightForgeRecipe.Serializer::new);
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<ScrapperRecipe>> scrapper_serializer =
            SERIALIZERS.register("scrapper", ScrapperRecipe.Serializer::new);

    public static final DeferredHolder<RecipeType<?>, RecipeType<MoonlightForgeRecipe>> moonlight_forge =
            TYPES.register("moonlight_forge", () -> new RecipeType<>() {
                @Override
                public String toString() {
                    return TheAurorian.MODID + ":moonlight_forge";
                }
            });
    public static final DeferredHolder<RecipeType<?>, RecipeType<ScrapperRecipe>> scrapper =
            TYPES.register("scrapper", () -> new RecipeType<>() {
                @Override
                public String toString() {
                    return TheAurorian.MODID + ":scrapper";
                }
            });
}
